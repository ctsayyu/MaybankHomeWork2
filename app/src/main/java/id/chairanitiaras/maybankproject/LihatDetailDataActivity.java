...
public class LihatDetailDataActivity extends AppCompatActivity {
    EditText edit_id, edit_nama, edit_norek, edit_notelp, edit_email, edit_saldo ;
    String id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        id = receiveIntent.getStringExtra(Konfigurasi.NAS_ID);
        edit_id.setText(id);
    ...
    private void displayDetailData(String json) {
        try {
            ...
            String notelp = object.getString(Konfigurasi.TAG_JSON_NOTELP);
